...
(function () {
    ...
    const OUTLINES = {
        ...
        europe: [
            [71.5,25.8],[70,19.5],[68,17],[66,14],[63,8],
            [59,5],[58,5.5],
            [55,8],[53.5,7.5],[52,4.5],[51,3.5],[50.5,2.5],
            [49.5,-1.5],[48.5,-4.5],[47.5,-2.5],[46,-1],[43.5,-1.8],
            [43.5,-8.5],[41,-8.7],[38.7,-9.5],[37,-8.6],[36.5,-7.8],
            [36,-7],[35.9,-5.7],[36,-5.3],[36.5,-2.5],
            [37.5,0.5],[43,3.5],[44,8],
            ...
            [66,14],[68,17],[70,19.5],[71.5,25.8],
        ],
        // European Russia extends the landmass east to the Urals
        europeRussia: [
            [60.5,25],[60,32],[62,34],[64,37],[66,43],[68,52],
            [67,57],[64,60],[60,60],[57,60],[54,58],[52,56],
            [50,53],[47,51],[45,47],[43,47],[43,40],
            [47,39],[50,38.5],[54,32],[56.5,31],[59.5,28],[60.5,25],
        ],
        // Great Britain
        uk: [
            [50.0,-5.7],[49.95,-5.1],[50.3,-3.5],[50.7,-1.0],[51.1,1.4],
            [51.5,1.5],[52.0,1.7],[52.6,1.7],[53.5,0.3],[53.7,-0.1],
            [54.5,-1.0],[54.7,-1.2],[55.0,-1.6],[55.5,-2.0],[55.9,-2.1],
            [56.2,-2.5],[56.4,-2.7],[57.0,-2.2],[57.7,-2.0],[58.2,-3.1],
            [58.6,-3.5],[58.6,-4.5],[58.3,-5.0],[57.8,-5.3],[57.3,-5.7],
            [56.5,-5.7],[55.7,-5.5],[55.4,-5.2],[55.0,-5.1],[54.6,-4.8],
            [54.0,-4.5],[53.4,-4.5],[52.8,-4.3],[52.0,-4.8],[51.6,-5.0],
            [51.4,-4.2],[51.2,-3.5],[51.0,-3.0],[50.7,-3.5],[50.5,-4.0],
            [50.3,-4.7],[50.1,-5.2],[50.0,-5.7],
        ],
        ireland: [
            [55.4,-7.1],[55.2,-6.1],[54.6,-5.9],[54.1,-5.9],[53.6,-6.0],
            [52.9,-6.0],[52.1,-6.3],[51.8,-8.3],[51.4,-9.5],[51.8,-10.5],
            [52.3,-10.6],[52.8,-10.0],[53.4,-10.0],[54.1,-10.1],
            [54.5,-8.5],[55.0,-7.7],[55.4,-7.1],
        ],
        // Scandinavian Peninsula (Norway + Sweden) as a solid fill island
        scandinavia: [
            [57.7,8.5],[58.5,8],[59.5,5.3],[60.5,5],[61,5.2],[62.5,6],[63.5,8],
            [65,14],[67,15.5],[68,17.5],[70,19.5],[71.5,25.8],[71,27],
            [69.5,31],[68.5,30],[67,29],[65,26],[64,22],[63,20],
            [62,18],[60,18.5],[59.5,19],[59.5,18.5],[58.5,17],[58,16.5],
            [57.0,16],[56.5,15.5],[55.5,13.5],[55.5,13],[55.5,12.5],
            [56,10.5],[57,9],[57.5,8.5],[57.7,8.5],
        ],
        // Finland + Karelian coast — ensures Helsinki appears on land
        finland: [
            [59.5,22],[60.5,21.5],[61.5,21],[62,21.5],[64,22],
            [65,25],[66.5,28],[68,28],[69,27.5],[69.5,28.5],[70,29],
            [70,30],[69,31],[67,30],[65,30],[63,32],[61,30],
            [60.5,29],[59.5,28],[59.5,25],[59.5,22],
        ],
        // Italian peninsula
        italy: [
            [44.4,8.9],[43.5,10.3],[42.5,11.3],[41.4,12.9],[40.8,14.2],
            [40.0,15.5],[38.3,15.5],[38.0,15.7],[38.1,16.0],[38.3,16.1],
            [39.0,17.0],[40.0,18.4],[41.0,17.0],[41.7,15.5],[41.8,14.9],
            [43.6,13.5],[44.5,12.3],[44.4,8.9],
        ],
        northAmerica: [
    ...
    // ---------------------------------------------------------------------------
    const VIEW_SHAPES = {
        world:        ['africa', 'europe', 'europeRussia', 'scandinavia', 'finland', 'uk', 'ireland', 'italy', 'northAmerica', 'southAmerica', 'asia', 'japan', 'australia', 'greenland'],
        europe:       ['europe', 'europeRussia', 'scandinavia', 'finland', 'uk', 'ireland', 'italy'],
    ...
    function geoMap(mapData, currentCityId, compact, dark) {
        return {
            ...
            continents: {
                ...
                oceania:      { label: 'Oceania',    cityIds: null, color: '#a78bfa' },
            },
