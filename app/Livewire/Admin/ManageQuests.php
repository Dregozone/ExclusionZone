...
class ManageQuests extends Component
{
    ...
    /**
     * @var array<int, array{id: ?int, step_order: int, city_id: ?int, person_of_interest: string, action_label: string, interaction_text: string, required_item_id: ?int, required_item_quantity: int, consumes_item: bool}>
     */
    public array $steps = [];
    ...
    public function quests(): Collection
    {
        ...
        return $query->get(['id', 'name', 'description', 'is_active', 'deleted_at']);
    }
